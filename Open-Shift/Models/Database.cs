	...
	public class Database
	{
		...
		public long InsertUser(User u)
		{
			try
			{
				...
				SetParameter(ref cm, "@address_line1", u.AddressLine1, SqlDbType.NVarChar);
                SetParameter(ref cm, "@address_line2", u.AddressLine2, SqlDbType.NVarChar);
			...
			try
			{
				...
				try
				{
					...
					if (ds.Tables[0].Rows.Count > 0)
					{
						...
						newUser.PostalCode = (string)dr["strZip"];
